...
namespace StandartsClient
{
    public class DisplayStandartModel
    {
        ...
        public DisplayStandartModel(Standart standart, Panel panel, bool isAddedToFavorite, DisplayStandartModel displayStandartModel = null, bool isUserForm = false, bool addTypeName = false, string typeName = "")
        {
